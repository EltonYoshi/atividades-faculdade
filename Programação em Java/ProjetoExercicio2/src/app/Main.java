...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("=== Produtos que foram vendidos na loja A mas que não foram vendidos na loja B===");
		...
		System.out.println("=== Produtos que foram vendidos na loja B mas que não foram vendidos na loja A===");
		    for(int i = 0; i < lojaB.length; i++) {
			    if(lojaB[i] != null) {
