...
public class FuncaoEventosDoUsuario {
	...
	//Método que mostrar os eventos PÚBLICOS que o usuário está participando
	public void mostrarEventosDoUsuario() {
		System.out.println("Digite seu CPF: ");
		this.cpf = sc.nextDouble();
		
		System.out.println("\nEVENTOS PÚBLICOS QUE VOCÊ ESTÁ PARTICIPANDO:\n");
	...
	//Método que permite o usuário cancelar a participação dele
	public void cancelarParticipacao() {
		int opcao = 0;
		do {
			System.out.println("Você deseja cancelar sua participação algum evento?");
			System.out.println("1 - Cancelar sua participação ");
