...
public class MenuOpcaoController {
	...
	public void efetuaEscolha(int escolha) {
		...
		case 1:
			...
			/*A ideia dessa função é dar a possibilidade do usuário realizar
		...
		case 2:
			...
			if(op == 1) {
				...
				System.out.println("\nEvento público criado com sucesso!\n");
		...
		case 3:
			...
			/*A ideia dessa função é dar a possibilidade do usuário
		...
		case 4:
			...
			/*A ideia dessa função é dar a possibilidade do usuário consultar
			 * os EVENTOS PÚBLICOS que ele se cadastrou*/
			FuncaoEventosDoUsuario eventosDoUsuario = new FuncaoEventosDoUsuario(cadastroEvento.getArmazenamentoDeEventos());
			
			//Retorna os EVENTOS PÚBLICOS que o usuário está cadastrado
			eventosDoUsuario.mostrarEventosDoUsuario();
			
			//Retorna um menu de opções que permite o cancelamento do cadastro em um evento
		...
		case 5:
			...
			//Retorna os EVENTOS PRIVADO que o usuário foi convidado
		...
		case 6:
			...
			/*A ideia dessa função é dar a possibilidade do usuário consultar todos os 
			 * EVENTOS PÚBLICOS que vão ocorrer, ocorreram e estão ocorrendo*/
			...
			//Retorna eventos que já aconteceram
			mostrarEventosPublicos.eventosOcorridos();
			
			//Retorna eventos que vão acontecer
			mostrarEventosPublicos.eventosOcorrer();
			
			//Retorna eventos que estão ocorrendo no momento da execução do programa
